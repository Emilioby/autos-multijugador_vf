class Game {
  constructor() {
    ...
    this.blast = false;
    //carro1
    this.car1smoked = false;
    this.car1smokedblack = false;
    this.car1fire = false;
    //carro2
    this.car2smoked = false;
    this.car2smokedblack = false;
    this.car2fire = false;
  }
  ...
  start() {
    ...
    //img
    car1.addImage("car1smoked", car1smokedImg);
    car1.scale = 0.07;
    car1.addImage("carblack", car1blackImg);
    car1.addImage("carfire", car1fireImg);
    ...
    //img
    car2.addImage("car1smoked", car2smokedImg);
    car2.scale = 0.07;
    car2.addImage("carblack", car2blackImg);
    car2.addImage("carfire", car2fireImg);
  ...
  play() {
    ...
    if (allPlayers !== undefined) {
      ...
      for (var plr in allPlayers) {
        ...
        //cambis de imagen de los autos al estilo gta
       if (currentlife <= 138.75) {
         cars[index - 1].changeImage("car1smoked");
         cars[index - 1].scale = 0.08;
        }

        if (currentlife <= 92.5 ) {
          cars[index - 1].changeImage("carblack");
          cars[index - 1].scale = 0.08;
         }

         if (currentlife <= 46.25 ) {
          cars[index - 1].changeImage("carfire");
          cars[index - 1].scale = 0.08;
         }
  ...
  handleObstacleCollision(index) {
    if(cars[index-1].collide(obstacle1)||cars[index-1].collide(obstacle2)){      //C41 //AM
